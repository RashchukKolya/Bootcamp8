...
//    */
  calculatePrice() {
    let stuffingsTotal = Hamburger.STUFFINGS[this._stuffing].price;
    let sizesTotal = Hamburger.SIZES[this._size].price;
    if(this._toppings.length > 0){
      let total = this._toppings.reduce((acc, el) => acc + Hamburger.TOPPINGS[el].price, 0)
      return stuffingsTotal + sizesTotal + total;
    } else {
      return stuffingsTotal + sizesTotal;
    }
...
//    */
  calculateCalories() {
    let stuffingsTotal = Hamburger.STUFFINGS[this._stuffing].calories;
    let sizesTotal = Hamburger.SIZES[this._size].calories;
    if(this._toppings.length > 0){
      let total = this._toppings.reduce((acc, el) => acc + Hamburger.TOPPINGS[el].calories, 0);
      return stuffingsTotal + sizesTotal + total;
    } else {
      return stuffingsTotal + sizesTotal;
    }
